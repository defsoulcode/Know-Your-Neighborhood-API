...
import com.kyn.jwtsecurity.TokenAuthenticationFilter;
import com.kyn.oauth2security.AuthorizationFailureHandler;
import com.kyn.oauth2security.AuthorizationSuccessHandler;
import com.kyn.oauth2security.HttpCookieAuthorizationRequestRepo;
import com.kyn.service.OAuth2UsersServiceImpl;
import com.kyn.service.UsersServiceImpl;
      ...
      http
              ...
              .authorizeRequests()
                  .antMatchers("/",
                      ...
                      "/**/*.js")
                      .permitAll()
                  .antMatchers("/online/**", "/store/**", "/oauth2/**")
                      .permitAll()
                  .anyRequest()
                      .authenticated()
                      .and()
