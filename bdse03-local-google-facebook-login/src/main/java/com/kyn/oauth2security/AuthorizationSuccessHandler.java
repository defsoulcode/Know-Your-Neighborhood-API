package com.kyn.oauth2security;
...
public class AuthorizationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler{
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        Optional<String> redirectUri = CookieUtils.getCookie(request, com.kyn.oauth2security.HttpCookieAuthorizationRequestRepo.REDIRECT_URI_PARAM_COOKIE_NAME)
                .map(Cookie::getValue);
